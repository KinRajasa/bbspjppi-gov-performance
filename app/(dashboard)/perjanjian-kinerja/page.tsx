...
export default function PerjanjianKinerjaPage() {
  ...
  // State untuk menyimpan link master Google Sheets
      ...
      <div className="space-y-6">
        ...
        <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
          ...
          <div className="p-6">
            ...
            {/* TAMBAHAN KOTAK INPUT URL GOOGLE SHEETS */}
            <div className="mt-6 border-t border-slate-100 pt-6">
              <label className="block text-sm font-semibold text-slate-700 mb-2">
                Tautan Master Google Sheets <span className="text-red-500">*</span>
              </label>
              <input
                type="url"
                className="w-full lg:w-3/4 border border-slate-300 rounded-md px-3 py-2 text-sm text-slate-700 outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition"
              ...
              <p className="text-xs text-slate-500 mt-2">
                * Spreadsheet ini akan diakses oleh sistem untuk menarik data realisasi secara otomatis.
              </p>
            </div>
          </div>
        </div>
